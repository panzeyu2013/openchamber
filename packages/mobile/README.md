...
- When the Catalog resolves a workspace session, mobile binds its SyncProvider,
  files/Git/terminal APIs, and session actions to that workspace handle. Catalog

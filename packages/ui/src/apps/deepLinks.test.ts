...
describe('project-scoped session deep links', () => {
  test('round-trips the composite project/session target', () => {
    const url = buildDeepLink({
      type: 'session',
      sessionId: 'session/with spaces',
      directory: '/srv/project',
      projectId: 'workspace-remote',
    });
  ...
  test('keeps legacy session links compatible without a project id', () => {

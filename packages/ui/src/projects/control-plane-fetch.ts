...
/**
 * Control-plane pinned fetch for the Project Catalog, Session Index and
 * project-bound SDK clients.
 *
 ...
 * Active Runtime and send `/api/projects` to e.g.
 * `https://active-remote.example/api/projects`, silently swapping the
 ...
 * project-bound client produces absolute URLs on the WINDOW origin (vite

...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.modelControls.loadingModels': '모델 로드 중...',
  'chat.modelControls.modelLoadFailed': '{server}에서 모델을 로드하지 못했습니다',
  ...
  'server.sidebar.status.reconnecting': '{label}에 다시 연결 중...',
  'server.sidebar.status.clickToReconnect': '서버 연결이 끊겼습니다. 클릭하여 다시 연결하세요.',
  'server.sidebar.search.searchingServers': '서버 {count}개 검색 중',
  'server.sidebar.localLabel': '로컬',
  'server.sidebar.manageServers': '서버 관리',
  'server.sidebar.actions.connect': '서버에 연결',
  'server.sidebar.actions.disconnect': '서버 연결 해제',
  'server.sidebar.actions.reconnect': '다시 연결',
  'server.sidebar.actions.disconnectConfirm': '이 서버 연결을 해제하시겠습니까?',
  'server.sidebar.status.label': '서버 상태: {status}',
  'server.sidebar.type.remote': '원격',
  'server.sidebar.noProjects': '{label}에 프로젝트가 없습니다.',
  'directoryExplorerDialog.server.placeholder': '서버 선택...',
  'directoryExplorerDialog.server.disconnected': '서버 연결 끊김',
  'directoryExplorerDialog.remote.listing': '{server}의 파일 나열 중...',
  'directoryExplorerDialog.remote.timeout': '원격 서버 응답 시간이 초과되었습니다',
  'directoryExplorerDialog.remote.disconnected': '서버 연결 끊김',
  'directoryExplorerDialog.remote.error': '{server}에 연결할 수 없습니다',
  'directoryExplorerDialog.remote.returnToLocal': '로컬로 돌아가기',
  'directoryExplorerDialog.remote.retry': '다시 시도',

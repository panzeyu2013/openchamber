...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.header.actions.addWorkspace': '작업 영역 추가',
  ...
  'workspaces.dialog.title': '작업 영역 추가',
  'workspaces.sidebar.title': '작업 영역',
  'workspaces.sidebar.empty': '아직 작업 영역이 없습니다.',
  'workspaces.sidebar.empty.add': '작업 영역 추가',
  'workspaces.sidebar.stale': '오래된 정보',
  'workspaces.sidebar.serverOf': '{server}에서',
  'workspaces.sidebar.moreAvailable': '세션이 더 있습니다',
  'workspaces.sidebar.openSessionAria': '{workspace}에서 {title} 열기',
  'workspaces.sidebar.remoteNotWired': '다른 서버의 세션 열기는 동기화 마이그레이션에서 제공됩니다.',
  'workspaces.dialog.description': '서버와 서버의 경로를 선택하세요. 모든 서버의 작업 영역이 하나의 목록에 표시됩니다.',
  'workspaces.dialog.server.label': '서버',
  'workspaces.dialog.server.placeholder': '서버 선택',
  'workspaces.dialog.server.loading': '서버를 불러오는 중...',
  ...
  'workspaces.dialog.server.thisComputer': '이 컴퓨터',
  'workspaces.dialog.path.label': '경로',
  'workspaces.dialog.path.placeholder': '서버에서 경로를 선택하거나 입력하세요',
  'workspaces.dialog.path.browse': '찾아보기',
  'workspaces.dialog.path.browseAria': '선택한 서버의 폴더 찾아보기',
  'workspaces.dialog.name.label': '이름',
  'workspaces.dialog.name.placeholder': '작업 영역 이름',
  'workspaces.dialog.color.label': '색상',
  'workspaces.dialog.color.placeholder': '선택 사항',
  'workspaces.dialog.actions.add': '작업 영역 추가',
  'workspaces.dialog.actions.adding': '추가하는 중...',
  'workspaces.dialog.error.required': '서버를 선택하고 경로를 입력하세요.',
  'workspaces.dialog.error.createFailed': '작업 영역을 추가하지 못했습니다.',
  'workspaces.dialog.toast.added': '작업 영역 "{label}" 추가됨',
  'workspaces.dialog.browse.loading': '폴더를 불러오는 중...',
  'workspaces.dialog.browse.loadFailed': '폴더를 찾아볼 수 없습니다.',
  'workspaces.dialog.browse.empty': '폴더가 없습니다.',
  'workspaces.dialog.browse.choose': '이 폴더 선택',
  'workspaces.dialog.browse.upAria': '상위 폴더로 이동',

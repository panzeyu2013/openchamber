...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.header.openProjectAria': '프로젝트 패널 열기',
  ...
  'sessions.sidebar.group.empty.noSessionsInProject': '아직 이 프로젝트에 세션 없음',
  ...
  'gitView.empty.worktreeFeaturesUnavailable': '이 프로젝트 모드에서는 워크트리 기능을 사용할 수 없습니다.',
  ...
  'projects.dialog.title': '프로젝트 추가',
  'projects.sidebar.title': '프로젝트',
  'projects.sidebar.empty': '아직 프로젝트가 없습니다.',
  'projects.sidebar.empty.add': '프로젝트 추가',
  'projects.sidebar.stale': '오래된 정보',
  'projects.sidebar.serverOf': '{server}에서',
  'projects.sidebar.moreAvailable': '세션이 더 있습니다',
  'projects.sidebar.menu.edit': '편집...',
  'projects.sidebar.menu.remove': '제거',
  'projects.sidebar.menu.removeConfirm': '{label}을(를) 제거할까요?',
  'projects.sidebar.serverHasMoreSessions': '이 서버에 더 많은 세션이 있습니다',
  'projects.sidebar.openSessionAria': '{project}에서 {title} 열기',
  'projects.sidebar.unavailable': '이 런타임에서는 프로젝트를 사용할 수 없습니다.',
  'projects.sidebar.newSessionUnavailable': '지금은 이 서버에서 세션을 시작할 수 없습니다.',
  'projects.sidebar.capabilityDisabled.title': '프로젝트 카탈로그가 비활성화되었습니다',
  'projects.sidebar.capabilityDisabled.description': '서버 관리자가 프로젝트 카탈로그를 비활성화했습니다. 프로젝트는 유지되며 읽기 전용으로 표시됩니다. 프로젝트 추가, 편집, 열기가 불가능합니다.',
  'projects.capability.terminalUnavailable': '이 프로젝트의 연결에서는 터미널을 사용할 수 없습니다.',
  'projects.dialog.description': '서버와 서버의 경로를 선택하세요. 모든 서버의 프로젝트가 하나의 목록에 표시됩니다.',
  'projects.dialog.server.label': '서버',
  'projects.dialog.server.placeholder': '서버 선택',
  'projects.dialog.server.loading': '서버를 불러오는 중...',
  ...
  'projects.dialog.server.error.sshCommandRequired': 'SSH 명령을 입력하세요.',
  ...
  'projects.dialog.server.form.type': '연결 유형',
  'projects.dialog.server.form.typeUrl': 'URL',
  'projects.dialog.server.form.typeSsh': 'SSH',
  'projects.dialog.server.form.nickname': '별명',
  'projects.dialog.server.form.nicknamePlaceholder': '예: 빌드 서버',
  'projects.dialog.server.form.sshCommand': 'SSH 명령',
  'projects.dialog.server.form.sshCommandPlaceholder': '예: ssh user@host',
  'projects.dialog.server.form.sshCreated': 'SSH 연결이 생성되었습니다. 서버 설정에서 관리할 수 있습니다.',
  'projects.dialog.server.form.save': 'Save server',
  'projects.dialog.server.form.saving': 'Saving...',
  'projects.dialog.server.thisComputer': '이 컴퓨터',
  'projects.dialog.serverProbe.checking': '연결 확인 중...',
  'projects.dialog.serverProbe.connected': '서버 연결됨',
  'projects.dialog.serverProbe.connectedWithLatency': '{latencyMs} ms에 서버 연결됨',
  'projects.dialog.serverProbe.unreachable': '서버에 연결할 수 없습니다. 등록은 완료되었으니 다시 시도하거나 계속할 수 있습니다.',
  'projects.dialog.serverProbe.retry': '다시 시도',
  'projects.dialog.serverProbe.continue': '계속',
  'projects.dialog.serverProbe.registeredNote': '서버가 등록되었지만 연결할 수 없음',
  'projects.dialog.path.label': '경로',
  'projects.dialog.path.placeholder': '서버에서 경로를 선택하거나 입력하세요',
  'projects.dialog.path.browse': '찾아보기',
  'projects.dialog.path.browseAria': '선택한 서버의 폴더 찾아보기',
  'projects.dialog.name.label': '이름',
  'projects.dialog.name.placeholder': '프로젝트 이름',
  'projects.dialog.color.label': '색상',
  'projects.dialog.color.placeholder': '선택 사항',
  'projects.dialog.actions.add': '프로젝트 추가',
  'projects.dialog.actions.adding': '추가하는 중...',
  'projects.dialog.error.required': '서버를 선택하고 경로를 입력하세요.',
  'projects.dialog.error.createFailed': '프로젝트를 추가하지 못했습니다.',
  'projects.dialog.toast.added': '프로젝트 "{label}" 추가됨',
  'projects.dialog.browse.loading': '폴더를 불러오는 중...',
  'projects.dialog.browse.loadFailed': '폴더를 찾아볼 수 없습니다.',
  'projects.dialog.browse.empty': '폴더가 없습니다.',
  'projects.dialog.browse.choose': '이 폴더 선택',
  'projects.dialog.browse.upAria': '상위 폴더로 이동',
  ...
  'chat.pendingChanges.changedInProject': '이 프로젝트에서 변경',

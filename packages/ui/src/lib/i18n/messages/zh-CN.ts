...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.header.actions.addWorkspace': '添加工区',
  ...
  'workspaces.dialog.title': '添加工区',
  'workspaces.sidebar.title': '工作区',
  'workspaces.sidebar.empty': '还没有工作区。',
  'workspaces.sidebar.empty.add': '添加工区',
  'workspaces.sidebar.stale': '已过期',
  'workspaces.sidebar.serverOf': '在 {server} 上',
  'workspaces.sidebar.moreAvailable': '还有更多会话',
  'workspaces.sidebar.openSessionAria': '在 {workspace} 中打开 {title}',
  'workspaces.sidebar.remoteNotWired': '从其他服务器打开会话将随同步迁移提供。',
  'workspaces.dialog.description': '选择服务器及其上的路径。所有服务器的工作区都显示在同一个列表中。',
  'workspaces.dialog.server.label': '服务器',
  'workspaces.dialog.server.placeholder': '选择服务器',
  'workspaces.dialog.server.loading': '正在加载服务器...',
  ...
  'workspaces.dialog.server.thisComputer': '此电脑',
  'workspaces.dialog.path.label': '路径',
  'workspaces.dialog.path.placeholder': '选择或输入服务器上的路径',
  'workspaces.dialog.path.browse': '浏览',
  'workspaces.dialog.path.browseAria': '浏览所选服务器上的文件夹',
  'workspaces.dialog.name.label': '名称',
  'workspaces.dialog.name.placeholder': '工作区名称',
  'workspaces.dialog.color.label': '颜色',
  'workspaces.dialog.color.placeholder': '可选',
  'workspaces.dialog.actions.add': '添加工区',
  'workspaces.dialog.actions.adding': '正在添加...',
  'workspaces.dialog.error.required': '请选择服务器并输入路径。',
  'workspaces.dialog.error.createFailed': '无法添加工作区。',
  'workspaces.dialog.toast.added': '已添加工作区“{label}”',
  'workspaces.dialog.browse.loading': '正在加载文件夹...',
  'workspaces.dialog.browse.loadFailed': '无法浏览文件夹。',
  'workspaces.dialog.browse.empty': '这里没有文件夹。',
  'workspaces.dialog.browse.choose': '选择此文件夹',
  'workspaces.dialog.browse.upAria': '转到父文件夹',

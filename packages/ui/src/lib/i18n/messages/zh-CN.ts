...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.modelControls.loadingModels': '正在加载模型...',
  'chat.modelControls.modelLoadFailed': '从 {server} 加载模型失败',
  ...
  'server.sidebar.status.reconnecting': '正在重新连接到 {label}...',
  'server.sidebar.status.clickToReconnect': '服务器已断开。点击重新连接。',
  'server.sidebar.search.searchingServers': '正在搜索 {count} 个服务器',
  'server.sidebar.localLabel': '本地',
  'server.sidebar.manageServers': '管理服务器',
  'server.sidebar.actions.connect': '连接到服务器',
  'server.sidebar.actions.disconnect': '断开服务器',
  'server.sidebar.actions.reconnect': '重新连接',
  'server.sidebar.actions.disconnectConfirm': '确定要断开此服务器吗？',
  'server.sidebar.status.label': '服务器状态：{status}',
  'server.sidebar.type.remote': '远程',
  'server.sidebar.noProjects': '{label} 上没有项目。',
  'directoryExplorerDialog.server.placeholder': '选择服务器...',
  'directoryExplorerDialog.server.disconnected': '服务器已断开',
  'directoryExplorerDialog.remote.listing': '正在列出 {server} 上的文件...',
  'directoryExplorerDialog.remote.timeout': '远程服务器响应超时',
  'directoryExplorerDialog.remote.disconnected': '服务器已断开',
  'directoryExplorerDialog.remote.error': '无法连接到 {server}',
  'directoryExplorerDialog.remote.returnToLocal': '返回本地',
  'directoryExplorerDialog.remote.retry': '重试',

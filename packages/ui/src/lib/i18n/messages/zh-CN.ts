...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.header.openProjectAria': '打开项目面板',
  ...
  'sessions.sidebar.group.empty.noSessionsInProject': '该项目暂无会话。',
  ...
  'gitView.empty.worktreeFeaturesUnavailable': '当前项目模式下，工作树功能不可用。',
  ...
  'projects.dialog.title': '添加项目',
  'projects.sidebar.title': '项目',
  'projects.sidebar.empty': '还没有项目。',
  'projects.sidebar.empty.add': '添加项目',
  'projects.sidebar.stale': '已过期',
  'projects.sidebar.serverOf': '在 {server} 上',
  'projects.sidebar.moreAvailable': '还有更多会话',
  'projects.sidebar.menu.edit': '编辑...',
  'projects.sidebar.menu.remove': '移除',
  'projects.sidebar.menu.removeConfirm': '移除 {label}？',
  'projects.sidebar.serverHasMoreSessions': '该服务器上还有更多会话',
  'projects.sidebar.openSessionAria': '在 {project} 中打开 {title}',
  'projects.sidebar.unavailable': '此环境中项目不可用。',
  'projects.sidebar.newSessionUnavailable': '暂时无法在此服务器上新建会话。',
  'projects.sidebar.capabilityDisabled.title': '项目目录已禁用',
  'projects.sidebar.capabilityDisabled.description': '服务器管理员已禁用项目目录。你的项目会被保留并以只读方式显示——添加、编辑和打开项目均不可用。',
  'projects.capability.terminalUnavailable': '此项目的连接不支持终端。',
  'projects.dialog.description': '选择服务器及其上的路径。所有服务器的项目都显示在同一个列表中。',
  'projects.dialog.server.label': '服务器',
  'projects.dialog.server.placeholder': '选择服务器',
  'projects.dialog.server.loading': '正在加载服务器...',
  ...
  'projects.dialog.server.error.sshCommandRequired': '请输入 SSH 命令。',
  ...
  'projects.dialog.server.form.type': '连接类型',
  'projects.dialog.server.form.typeUrl': 'URL',
  'projects.dialog.server.form.typeSsh': 'SSH',
  'projects.dialog.server.form.nickname': '昵称',
  'projects.dialog.server.form.nicknamePlaceholder': '例如：构建服务器',
  'projects.dialog.server.form.sshCommand': 'SSH 命令',
  'projects.dialog.server.form.sshCommandPlaceholder': '例如：ssh user@host',
  'projects.dialog.server.form.sshCreated': 'SSH 连接已创建。可在服务器设置中管理。',
  'projects.dialog.server.form.save': 'Save server',
  'projects.dialog.server.form.saving': 'Saving...',
  'projects.dialog.server.thisComputer': '此电脑',
  'projects.dialog.serverProbe.checking': '正在检查连接...',
  'projects.dialog.serverProbe.connected': '服务器已连接',
  'projects.dialog.serverProbe.connectedWithLatency': '服务器在 {latencyMs} ms 内已连接',
  'projects.dialog.serverProbe.unreachable': '服务器不可达。它已被注册——你可以重试或继续。',
  'projects.dialog.serverProbe.retry': '重试',
  'projects.dialog.serverProbe.continue': '继续',
  'projects.dialog.serverProbe.registeredNote': '服务器已注册，但不可达',
  'projects.dialog.path.label': '路径',
  'projects.dialog.path.placeholder': '选择或输入服务器上的路径',
  'projects.dialog.path.browse': '浏览',
  'projects.dialog.path.browseAria': '浏览所选服务器上的文件夹',
  'projects.dialog.name.label': '名称',
  'projects.dialog.name.placeholder': '项目名称',
  'projects.dialog.color.label': '颜色',
  'projects.dialog.color.placeholder': '可选',
  'projects.dialog.actions.add': '添加项目',
  'projects.dialog.actions.adding': '正在添加...',
  'projects.dialog.error.required': '请选择服务器并输入路径。',
  'projects.dialog.error.createFailed': '无法添加项目。',
  'projects.dialog.toast.added': '已添加项目“{label}”',
  'projects.dialog.browse.loading': '正在加载文件夹...',
  'projects.dialog.browse.loadFailed': '无法浏览文件夹。',
  'projects.dialog.browse.empty': '这里没有文件夹。',
  'projects.dialog.browse.choose': '选择此文件夹',
  'projects.dialog.browse.upAria': '转到父文件夹',
  ...
  'chat.pendingChanges.changedInProject': '此项目中有变更',

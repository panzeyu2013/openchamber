export const settingsDict = {
  ...
  'settings.view.nav.group.projects': '项目',
  'settings.view.nav.group.opencode': 'OpenCode',
  'settings.view.nav.group.content': '资源库',
  'settings.page.projects.title': '项目',
  'settings.page.servers.title': '服务器',
  'settings.page.devices.title': '设备',
  'settings.page.servers.description': '管理已保存的服务器及其连接状态。',
  'settings.servers.sidebar.total': '共 {count} 个',
  'settings.servers.sidebar.actions.addServer': '添加服务器',
  'settings.servers.page.unavailable': '服务器当前不可用。',
  'settings.servers.page.status.checking': '检查中...',
  'settings.servers.page.status.connected': '已连接',
  'settings.servers.page.status.unreachable': '不可达',
  'settings.servers.page.status.neverConnected': '从未连接',
  'settings.servers.page.status.latency': '{latencyMs} 毫秒',
  'settings.servers.page.lastConnectedAt': '上次连接：{date}',
  'settings.servers.page.freshness.label': '会话索引',
  'settings.servers.page.freshness.synced': '已同步',
  'settings.servers.page.freshness.stale': '已过期',
  'settings.servers.page.freshness.offline': '离线',
  'settings.servers.page.freshness.unknown': '未知',
  'settings.servers.page.actions.addServer': '添加服务器',
  'settings.servers.page.actions.addServerDescription': '通过 URL 和访问令牌注册新服务器。',
  'settings.servers.page.actions.test': '测试连接',
  'settings.servers.page.actions.edit': '编辑名称',
  'settings.servers.page.actions.remove': '移除',
  'settings.servers.page.empty.noServers': '还没有服务器。添加一个以使用其他机器上的项目。',
  'settings.servers.page.section.addServer': '添加服务器',
  'settings.servers.page.edit.title': '编辑服务器',
  'settings.servers.page.edit.keepUrl': '留空以保留当前 URL',
  'settings.servers.page.edit.keepToken': '留空以保留当前令牌',
  'settings.servers.page.edit.labelRequired': '请输入服务器名称。',
  'settings.servers.page.edit.actions.save': '保存',
  'settings.servers.page.confirm.remove.title': '移除服务器？',
  'settings.servers.page.confirm.remove.description': '该服务器将从已保存的连接中移除。',
  'settings.servers.page.confirm.remove.confirm': '移除',
  'settings.servers.page.toast.removed': '服务器已移除',
  'settings.servers.probe.checking': '正在检查连接...',
  'settings.servers.probe.unreachable': '服务器不可达。它已被注册——你可以重试或继续。',
  'settings.servers.probe.retry': '重试',
  'settings.servers.probe.continue': '继续',

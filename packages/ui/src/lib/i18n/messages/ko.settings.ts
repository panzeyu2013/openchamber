export const settingsDict = {
  ...
  'settings.view.nav.group.projects': '프로젝트',
  'settings.view.nav.group.opencode': 'OpenCode',
  'settings.view.nav.group.content': '라이브러리',
  'settings.page.projects.title': '프로젝트',
  'settings.page.servers.title': '서버',
  'settings.page.devices.title': '기기',
  'settings.page.servers.description': '저장된 서버와 연결 상태를 관리합니다.',
  'settings.servers.sidebar.total': '총 {count}',
  'settings.servers.sidebar.actions.addServer': '서버 추가',
  'settings.servers.page.unavailable': '지금은 서버를 사용할 수 없습니다.',
  'settings.servers.page.status.checking': '확인 중...',
  'settings.servers.page.status.connected': '연결됨',
  'settings.servers.page.status.unreachable': '연결 불가',
  'settings.servers.page.status.neverConnected': '연결된 적 없음',
  'settings.servers.page.status.latency': '{latencyMs} ms',
  'settings.servers.page.lastConnectedAt': '마지막 연결: {date}',
  'settings.servers.page.freshness.label': '세션 인덱스',
  'settings.servers.page.freshness.synced': '동기화됨',
  'settings.servers.page.freshness.stale': '오래됨',
  'settings.servers.page.freshness.offline': '오프라인',
  'settings.servers.page.freshness.unknown': '알 수 없음',
  'settings.servers.page.actions.addServer': '서버 추가',
  'settings.servers.page.actions.addServerDescription': 'URL과 액세스 토큰으로 새 서버를 등록합니다.',
  'settings.servers.page.actions.test': '연결 테스트',
  'settings.servers.page.actions.edit': '이름 편집',
  'settings.servers.page.actions.remove': '제거',
  'settings.servers.page.empty.noServers': '아직 서버가 없습니다. 다른 컴퓨터의 프로젝트를 사용하려면 서버를 추가하세요.',
  'settings.servers.page.section.addServer': '서버 추가',
  'settings.servers.page.edit.title': '서버 편집',
  'settings.servers.page.edit.keepUrl': '비워 두면 현재 URL이 유지됩니다',
  'settings.servers.page.edit.keepToken': '비워 두면 현재 토큰이 유지됩니다',
  'settings.servers.page.edit.labelRequired': '서버 이름을 입력하세요.',
  'settings.servers.page.edit.actions.save': '저장',
  'settings.servers.page.confirm.remove.title': '서버를 제거할까요?',
  'settings.servers.page.confirm.remove.description': '저장된 연결에서 서버가 제거됩니다.',
  'settings.servers.page.confirm.remove.confirm': '제거',
  'settings.servers.page.toast.removed': '서버 제거됨',
  'settings.servers.probe.checking': '연결 확인 중...',
  'settings.servers.probe.unreachable': '서버에 연결할 수 없습니다. 등록은 완료되었으니 다시 시도하거나 계속할 수 있습니다.',
  'settings.servers.probe.retry': '다시 시도',
  'settings.servers.probe.continue': '계속',

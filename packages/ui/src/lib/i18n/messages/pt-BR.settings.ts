export const settingsDict = {
  ...
  "settings.view.nav.group.projects": "Projetos",
  ...
  "settings.page.servers.description": "Gerencie os servidores salvos e o status da conexão.",
  "settings.servers.sidebar.total": "Total {count}",
  "settings.servers.sidebar.actions.addServer": "Adicionar servidor",
  "settings.servers.page.unavailable": "Os servidores não estão disponíveis no momento.",
  "settings.servers.page.status.checking": "Verificando...",
  "settings.servers.page.status.connected": "Conectado",
  "settings.servers.page.status.unreachable": "Inacessível",
  "settings.servers.page.status.neverConnected": "Nunca conectado",
  "settings.servers.page.status.latency": "{latencyMs} ms",
  "settings.servers.page.lastConnectedAt": "Última conexão: {date}",
  "settings.servers.page.freshness.label": "Índice de sessões",
  "settings.servers.page.freshness.synced": "Sincronizado",
  "settings.servers.page.freshness.stale": "Desatualizado",
  "settings.servers.page.freshness.offline": "Offline",
  "settings.servers.page.freshness.unknown": "Desconhecido",
  "settings.servers.page.actions.addServer": "Adicionar servidor",
  "settings.servers.page.actions.addServerDescription": "Registre um novo servidor por URL e token de acesso.",
  "settings.servers.page.actions.test": "Testar conexão",
  "settings.servers.page.actions.edit": "Editar nome",
  "settings.servers.page.actions.remove": "Remover",
  "settings.servers.page.empty.noServers": "Ainda não há servidores. Adicione um para usar projetos de outras máquinas.",
  "settings.servers.page.section.addServer": "Adicionar servidor",
  "settings.servers.page.edit.title": "Editar servidor",
  "settings.servers.page.edit.keepUrl": "Deixe vazio para manter a URL atual",
  "settings.servers.page.edit.keepToken": "Deixe vazio para manter o token atual",
  "settings.servers.page.edit.labelRequired": "Digite um nome de servidor.",
  "settings.servers.page.edit.actions.save": "Salvar",
  "settings.servers.page.confirm.remove.title": "Remover servidor?",
  "settings.servers.page.confirm.remove.description": "O servidor será removido das suas conexões salvas.",
  "settings.servers.page.confirm.remove.confirm": "Remover",
  "settings.servers.page.toast.removed": "Servidor removido",
  "settings.servers.probe.checking": "Verificando conexão...",
  "settings.servers.probe.unreachable": "Servidor inacessível. Ele foi registrado mesmo assim — você pode tentar novamente ou continuar.",
  "settings.servers.probe.retry": "Tentar novamente",

export const settingsDict = {
  ...
  "settings.view.nav.group.projects": "Proyectos",
  ...
  "settings.page.servers.title": "Servidores",
  "settings.page.devices.title": "Dispositivos",
  "settings.page.servers.description": "Administra los servidores guardados y su estado de conexión.",
  "settings.servers.sidebar.total": "Total {count}",
  "settings.servers.sidebar.actions.addServer": "Añadir servidor",
  "settings.servers.page.unavailable": "Los servidores no están disponibles en este momento.",
  "settings.servers.page.status.checking": "Comprobando...",
  "settings.servers.page.status.connected": "Conectado",
  "settings.servers.page.status.unreachable": "Inaccesible",
  "settings.servers.page.status.neverConnected": "Nunca conectado",
  "settings.servers.page.status.latency": "{latencyMs} ms",
  "settings.servers.page.lastConnectedAt": "Última conexión: {date}",
  "settings.servers.page.freshness.label": "Índice de sesiones",
  "settings.servers.page.freshness.synced": "Sincronizado",
  "settings.servers.page.freshness.stale": "Desactualizado",
  "settings.servers.page.freshness.offline": "Sin conexión",
  "settings.servers.page.freshness.unknown": "Desconocido",
  "settings.servers.page.actions.addServer": "Añadir servidor",
  "settings.servers.page.actions.addServerDescription": "Registra un nuevo servidor por URL y token de acceso.",
  "settings.servers.page.actions.test": "Probar conexión",
  "settings.servers.page.actions.edit": "Editar etiqueta",
  "settings.servers.page.actions.remove": "Eliminar",
  "settings.servers.page.empty.noServers": "Aún no hay servidores. Añade uno para usar proyectos de otras máquinas.",
  "settings.servers.page.section.addServer": "Añadir servidor",
  "settings.servers.page.edit.title": "Editar servidor",
  "settings.servers.page.edit.keepUrl": "Déjalo vacío para conservar la URL actual",
  "settings.servers.page.edit.keepToken": "Déjalo vacío para conservar el token actual",
  "settings.servers.page.edit.labelRequired": "Introduce un nombre de servidor.",
  "settings.servers.page.edit.actions.save": "Guardar",
  "settings.servers.page.confirm.remove.title": "¿Eliminar servidor?",
  "settings.servers.page.confirm.remove.description": "El servidor se eliminará de tus conexiones guardadas.",
  "settings.servers.page.confirm.remove.confirm": "Eliminar",
  "settings.servers.page.toast.removed": "Servidor eliminado",
  "settings.servers.probe.checking": "Comprobando conexión...",
  "settings.servers.probe.unreachable": "Servidor inaccesible. Igual quedó registrado: puedes reintentar o continuar.",
  "settings.servers.probe.retry": "Reintentar",
  "settings.servers.probe.continue": "Continuar",

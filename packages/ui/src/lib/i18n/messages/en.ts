...
export const dict = {
  ...
  'mobile.header.openProjectAria': 'Open project panel',
  ...
  'sessions.sidebar.group.empty.noSessionsInProject': 'No sessions in this project yet.',
  ...
  'projects.dialog.title': 'Add project',
  'projects.sidebar.title': 'Projects',
  'projects.sidebar.empty': 'No projects yet.',
  'projects.sidebar.empty.add': 'Add a project',
  'projects.sidebar.stale': 'Out of date',
  'projects.sidebar.serverOf': 'on {server}',
  'projects.sidebar.menu.edit': 'Edit...',
  'projects.sidebar.menu.remove': 'Remove',
  'projects.sidebar.menu.removeConfirm': 'Remove {label}?',
  'projects.sidebar.moreAvailable': 'More sessions available',
  'projects.sidebar.serverHasMoreSessions': 'More sessions available on this server',
  'projects.sidebar.openSessionAria': 'Open {title} in {project}',
  'projects.sidebar.unavailable': 'Projects are unavailable in this runtime.',
  'projects.sidebar.newSessionUnavailable': "Can't start sessions on this server right now.",
  'projects.sidebar.capabilityDisabled.title': 'Project catalog is disabled',
  'projects.sidebar.capabilityDisabled.description': 'The server administrator disabled the project catalog. Your projects are preserved and shown read-only — adding, editing, and opening projects is unavailable.',
  'projects.capability.terminalUnavailable': 'Terminal is not available for this project\'s connection.',
  'projects.dialog.description': 'Choose a server and a path on it. Projects from all servers live in one list.',
  'projects.dialog.server.label': 'Server',
  'projects.dialog.server.placeholder': 'Select server',
  'projects.dialog.server.loading': 'Loading servers...',
  ...
  'projects.dialog.server.error.sshCommandRequired': 'Enter an SSH command.',
  ...
  'projects.dialog.server.form.type': 'Connection type',
  'projects.dialog.server.form.typeUrl': 'URL',
  'projects.dialog.server.form.typeSsh': 'SSH',
  'projects.dialog.server.form.nickname': 'Nickname',
  'projects.dialog.server.form.nicknamePlaceholder': 'e.g. Build server',
  'projects.dialog.server.form.sshCommand': 'SSH command',
  'projects.dialog.server.form.sshCommandPlaceholder': 'e.g. ssh user@host',
  'projects.dialog.server.form.sshCreated': 'SSH connection created. Manage it from Servers settings.',
  'projects.dialog.server.form.save': 'Save server',
  'projects.dialog.server.form.saving': 'Saving...',
  'projects.dialog.server.thisComputer': 'This computer',
  'projects.dialog.serverProbe.checking': 'Checking connection...',
  'projects.dialog.serverProbe.connected': 'Server connected',
  'projects.dialog.serverProbe.connectedWithLatency': 'Server connected in {latencyMs} ms',
  'projects.dialog.serverProbe.unreachable': 'Server unreachable. It was still registered — you can retry or continue.',
  'projects.dialog.serverProbe.retry': 'Retry',
  'projects.dialog.serverProbe.continue': 'Continue',
  'projects.dialog.serverProbe.registeredNote': 'Server registered, but unreachable',

  'projects.dialog.path.label': 'Path',
  'projects.dialog.path.placeholder': 'Select or enter a path on the server',
  'projects.dialog.path.browse': 'Browse',
  'projects.dialog.path.browseAria': 'Browse folders on the selected server',
  'projects.dialog.name.label': 'Name',
  'projects.dialog.name.placeholder': 'Project name',
  'projects.dialog.color.label': 'Color',
  'projects.dialog.color.placeholder': 'Optional',
  'projects.dialog.actions.add': 'Add project',
  'projects.dialog.actions.adding': 'Adding...',
  'projects.dialog.error.required': 'Choose a server and enter a path.',
  'projects.dialog.error.createFailed': 'Failed to add project.',
  'projects.dialog.toast.added': 'Project "{label}" added',
  'projects.dialog.browse.loading': 'Loading folders...',
  'projects.dialog.browse.loadFailed': 'Failed to browse folders.',
  'projects.dialog.browse.empty': 'No folders here.',
  'projects.dialog.browse.choose': 'Choose this folder',
  'projects.dialog.browse.upAria': 'Go to parent folder',
  ...
  'chat.pendingChanges.changedInProject': 'changed in this project',

...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.modelControls.loadingModels": "Cargando modelos...",
  "chat.modelControls.modelLoadFailed": "Error al cargar modelos desde {server}",
  ...
  "server.sidebar.status.clickToReconnect": "Servidor desconectado. Haga clic para reconectar.",
  "server.sidebar.search.searchingServers": "Buscando en {count} servidores",
  "server.sidebar.localLabel": "Local",
  "server.sidebar.manageServers": "Gestionar servidores",
  "server.sidebar.actions.connect": "Conectar al servidor",
  "server.sidebar.actions.disconnect": "Desconectar servidor",
  "server.sidebar.actions.reconnect": "Reconectar",
  "server.sidebar.actions.disconnectConfirm": "¿Está seguro de que desea desconectar este servidor?",
  "server.sidebar.status.label": "Estado del servidor: {status}",
  "server.sidebar.type.remote": "Remoto",
  "server.sidebar.noProjects": "No hay proyectos en {label}.",
  "directoryExplorerDialog.server.placeholder": "Seleccionar servidor...",
  "directoryExplorerDialog.server.disconnected": "Servidor desconectado",
  "directoryExplorerDialog.remote.listing": "Listando archivos en {server}...",
  "directoryExplorerDialog.remote.timeout": "La respuesta del servidor remoto agotó el tiempo",
  "directoryExplorerDialog.remote.disconnected": "Servidor desconectado",
  "directoryExplorerDialog.remote.error": "No se pudo conectar a {server}",
  "directoryExplorerDialog.remote.returnToLocal": "Volver a local",
  "directoryExplorerDialog.remote.retry": "Reintentar",

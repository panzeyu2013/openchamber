...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.modelControls.loadingModels": "Завантаження моделей...",
  "chat.modelControls.modelLoadFailed": "Не вдалося завантажити моделі з {server}",
  ...
  "server.sidebar.status.reconnecting": "Перепідключення до {label}...",
  "server.sidebar.status.clickToReconnect": "Сервер відключено. Натисніть, щоб перепідключитися.",
  "server.sidebar.search.searchingServers": "Пошук на {count} серверах",
  "server.sidebar.localLabel": "Локальний",
  "server.sidebar.manageServers": "Керування серверами",
  "server.sidebar.actions.connect": "Підключитися до сервера",
  "server.sidebar.actions.disconnect": "Відключити сервер",
  "server.sidebar.actions.reconnect": "Перепідключитися",
  "server.sidebar.actions.disconnectConfirm": "Ви впевнені, що хочете відключити цей сервер?",
  "server.sidebar.status.label": "Статус сервера: {status}",
  "server.sidebar.type.remote": "Віддалений",
  "server.sidebar.noProjects": "Немає проєктів на {label}.",
  "directoryExplorerDialog.server.placeholder": "Виберіть сервер...",
  "directoryExplorerDialog.server.disconnected": "Сервер відключено",
  "directoryExplorerDialog.remote.listing": "Список файлів на {server}...",
  "directoryExplorerDialog.remote.timeout": "Час очікування відповіді віддаленого сервера минув",
  "directoryExplorerDialog.remote.disconnected": "Сервер відключено",
  "directoryExplorerDialog.remote.error": "Не вдалося підключитися до {server}",
  "directoryExplorerDialog.remote.returnToLocal": "Повернутися до локального",
  "directoryExplorerDialog.remote.retry": "Повторити",

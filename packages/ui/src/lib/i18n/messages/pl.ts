...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.modelControls.loadingModels': 'Ładowanie modeli...',
  'chat.modelControls.modelLoadFailed': 'Nie udało się załadować modeli z {server}',
  ...
  'server.sidebar.status.reconnecting': 'Ponowne łączenie z {label}...',
  'server.sidebar.status.clickToReconnect': 'Serwer rozłączony. Kliknij, aby ponownie połączyć.',
  'server.sidebar.search.searchingServers': 'Przeszukiwanie {count} serwerów',
  'server.sidebar.localLabel': 'Lokalny',
  'server.sidebar.manageServers': 'Zarządzaj serwerami',
  'server.sidebar.actions.connect': 'Połącz z serwerem',
  'server.sidebar.actions.disconnect': 'Odłącz serwer',
  'server.sidebar.actions.reconnect': 'Połącz ponownie',
  'server.sidebar.actions.disconnectConfirm': 'Czy na pewno chcesz odłączyć ten serwer?',
  'server.sidebar.status.label': 'Status serwera: {status}',
  'server.sidebar.type.remote': 'Zdalny',
  'server.sidebar.noProjects': 'Brak projektów na {label}.',
  'directoryExplorerDialog.server.placeholder': 'Wybierz serwer...',
  'directoryExplorerDialog.server.disconnected': 'Serwer rozłączony',
  'directoryExplorerDialog.remote.listing': 'Wyświetlanie plików na {server}...',
  'directoryExplorerDialog.remote.timeout': 'Przekroczono czas odpowiedzi zdalnego serwera',
  'directoryExplorerDialog.remote.disconnected': 'Serwer rozłączony',
  'directoryExplorerDialog.remote.error': 'Nie można połączyć się z {server}',
  'directoryExplorerDialog.remote.returnToLocal': 'Wróć do lokalnego',
  'directoryExplorerDialog.remote.retry': 'Ponów próbę',

...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'sessions.fleet.title': 'Serwery',
  'sessions.fleet.status.connected': 'Połączono',
  'sessions.fleet.status.connecting': 'Łączenie',
  'sessions.fleet.status.degraded': 'Niedostępne',
  'sessions.fleet.status.disconnected': 'Rozłączono',
  'sessions.fleet.status.error': 'Błąd',
  'sessions.fleet.openServer': 'Otwórz {label}',
  ...
  'sessions.sidebar.header.actions.addWorkspace': 'Dodaj obszar roboczy',
  ...
  'workspaces.dialog.title': 'Dodaj obszar roboczy',
  'workspaces.sidebar.title': 'Obszary robocze',
  'workspaces.sidebar.empty': 'Brak obszarów roboczych.',
  'workspaces.sidebar.empty.add': 'Dodaj obszar roboczy',
  ...
  'workspaces.dialog.server.placeholder': 'Wybierz serwer',
  'workspaces.dialog.server.loading': 'Ładowanie serwerów...',
  ...
  'workspaces.dialog.server.thisComputer': 'Ten komputer',
  'workspaces.dialog.path.label': 'Ścieżka',
  'workspaces.dialog.path.placeholder': 'Wybierz lub wpisz ścieżkę na serwerze',
  'workspaces.dialog.path.browse': 'Przeglądaj',
  'workspaces.dialog.path.browseAria': 'Przeglądaj foldery na wybranym serwerze',
  'workspaces.dialog.name.label': 'Nazwa',
  'workspaces.dialog.name.placeholder': 'Nazwa obszaru roboczego',
  'workspaces.dialog.color.label': 'Kolor',
  'workspaces.dialog.color.placeholder': 'Opcjonalnie',
  'workspaces.dialog.actions.add': 'Dodaj obszar roboczy',
  'workspaces.dialog.actions.adding': 'Dodawanie...',
  'workspaces.dialog.error.required': 'Wybierz serwer i wpisz ścieżkę.',
  'workspaces.dialog.error.createFailed': 'Nie udało się dodać obszaru roboczego.',
  'workspaces.dialog.toast.added': 'Dodano obszar roboczy „{label}”',
  'workspaces.dialog.browse.loading': 'Ładowanie folderów...',
  'workspaces.dialog.browse.loadFailed': 'Nie udało się przeglądać folderów.',
  'workspaces.dialog.browse.empty': 'Brak folderów.',
  'workspaces.dialog.browse.choose': 'Wybierz ten folder',
  'workspaces.dialog.browse.upAria': 'Przejdź do folderu nadrzędnego',

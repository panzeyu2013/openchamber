...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.header.openProjectAria': 'Otwórz panel projektu',
  ...
  'sessions.sidebar.group.empty.noSessionsInProject': 'Brak sesji w tym projekcie.',
  ...
  'chat.pendingChanges.changedInProject': 'zmieniono w tym projekcie',
  ...
  'projects.dialog.title': 'Dodaj projekt',
  'projects.sidebar.title': 'Projekty',
  'projects.sidebar.empty': 'Brak projektów.',
  'projects.sidebar.empty.add': 'Dodaj projekt',
  'projects.sidebar.stale': 'Nieaktualne',
  'projects.sidebar.serverOf': 'na {server}',
  'projects.sidebar.moreAvailable': 'Dostępnych jest więcej sesji',
  'projects.sidebar.menu.edit': 'Edytuj...',
  'projects.sidebar.menu.remove': 'Usuń',
  'projects.sidebar.menu.removeConfirm': 'Usunąć {label}?',
  'projects.sidebar.serverHasMoreSessions': 'Na tym serwerze dostępnych jest więcej sesji',
  'projects.sidebar.openSessionAria': 'Otwórz {title} w {project}',
  'projects.sidebar.unavailable': 'Projekty są niedostępne w tym środowisku.',
  'projects.sidebar.newSessionUnavailable': 'Nie można teraz uruchamiać sesji na tym serwerze.',
  'projects.sidebar.capabilityDisabled.title': 'Katalog projektów jest wyłączony',
  'projects.sidebar.capabilityDisabled.description': 'Administrator serwera wyłączył katalog projektów. Twoje projekty są zachowane i wyświetlane tylko do odczytu — dodawanie, edytowanie i otwieranie projektów jest niedostępne.',
  'projects.capability.terminalUnavailable': 'Terminal nie jest dostępny dla połączenia tego projektu.',
  'projects.dialog.description': 'Wybierz serwer i ścieżkę na nim. Projekty ze wszystkich serwerów znajdują się na jednej liście.',
  'projects.dialog.server.label': 'Serwer',
  'projects.dialog.server.placeholder': 'Wybierz serwer',
  'projects.dialog.server.loading': 'Ładowanie serwerów...',
  ...
  'projects.dialog.server.error.sshCommandRequired': 'Wprowadź polecenie SSH.',
  ...
  'projects.dialog.server.form.type': 'Typ połączenia',
  'projects.dialog.server.form.typeUrl': 'URL',
  'projects.dialog.server.form.typeSsh': 'SSH',
  'projects.dialog.server.form.nickname': 'Pseudonim',
  'projects.dialog.server.form.nicknamePlaceholder': 'np. Serwer kompilacji',
  'projects.dialog.server.form.sshCommand': 'Polecenie SSH',
  'projects.dialog.server.form.sshCommandPlaceholder': 'np. ssh user@host',
  'projects.dialog.server.form.sshCreated': 'Utworzono połączenie SSH. Możesz nim zarządzać w ustawieniach serwerów.',
  'projects.dialog.server.form.save': 'Save server',
  'projects.dialog.server.form.saving': 'Saving...',
  'projects.dialog.server.thisComputer': 'Ten komputer',
  'projects.dialog.serverProbe.checking': 'Sprawdzanie połączenia...',
  'projects.dialog.serverProbe.connected': 'Serwer połączony',
  'projects.dialog.serverProbe.connectedWithLatency': 'Serwer połączony w {latencyMs} ms',
  'projects.dialog.serverProbe.unreachable': 'Serwer nieosiągalny. Został mimo to zarejestrowany — możesz spróbować ponownie lub kontynuować.',
  'projects.dialog.serverProbe.retry': 'Spróbuj ponownie',
  'projects.dialog.serverProbe.continue': 'Kontynuuj',
  'projects.dialog.serverProbe.registeredNote': 'Serwer zarejestrowany, ale nieosiągalny',
  'projects.dialog.path.label': 'Ścieżka',
  'projects.dialog.path.placeholder': 'Wybierz lub wpisz ścieżkę na serwerze',
  'projects.dialog.path.browse': 'Przeglądaj',
  'projects.dialog.path.browseAria': 'Przeglądaj foldery na wybranym serwerze',
  'projects.dialog.name.label': 'Nazwa',
  'projects.dialog.name.placeholder': 'Nazwa projektu',
  'projects.dialog.color.label': 'Kolor',
  'projects.dialog.color.placeholder': 'Opcjonalnie',
  'projects.dialog.actions.add': 'Dodaj projekt',
  'projects.dialog.actions.adding': 'Dodawanie...',
  'projects.dialog.error.required': 'Wybierz serwer i wpisz ścieżkę.',
  'projects.dialog.error.createFailed': 'Nie udało się dodać projektu.',
  'projects.dialog.toast.added': 'Dodano projekt „{label}”',
  'projects.dialog.browse.loading': 'Ładowanie folderów...',
  'projects.dialog.browse.loadFailed': 'Nie udało się przeglądać folderów.',
  'projects.dialog.browse.empty': 'Brak folderów.',
  'projects.dialog.browse.choose': 'Wybierz ten folder',
  'projects.dialog.browse.upAria': 'Przejdź do folderu nadrzędnego',
  ...
  'gitView.empty.worktreeFeaturesUnavailable': 'Worktree features are unavailable in this project mode.',

...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'sessions.fleet.title': '伺服器',
  'sessions.fleet.status.connected': '已連線',
  'sessions.fleet.status.connecting': '連線中',
  'sessions.fleet.status.degraded': '無法使用',
  'sessions.fleet.status.disconnected': '已中斷',
  'sessions.fleet.status.error': '錯誤',
  'sessions.fleet.openServer': '開啟 {label}',
  'sessions.fleet.openSession': '在 {server} 開啟 {title}',
  'sessions.fleet.stale': '已過期',
  'sessions.fleet.unavailable': '無法重新整理上次狀態',
  'sessions.fleet.questionRequired': '需要回答',
  'sessions.fleet.moreAvailable': '還有更多工作階段',
  ...
  'sessions.sidebar.header.actions.addWorkspace': '新增工作區',
  ...
  'workspaces.dialog.title': '新增工作區',
  'workspaces.sidebar.title': '工作區',
  'workspaces.sidebar.empty': '尚無工作區。',
  'workspaces.sidebar.empty.add': '新增工作區',
  ...
  'workspaces.dialog.server.placeholder': '選擇伺服器',
  'workspaces.dialog.server.loading': '正在載入伺服器...',
  ...
  'workspaces.dialog.server.thisComputer': '此電腦',
  'workspaces.dialog.path.label': '路徑',
  'workspaces.dialog.path.placeholder': '選擇或輸入伺服器上的路徑',
  'workspaces.dialog.path.browse': '瀏覽',
  'workspaces.dialog.path.browseAria': '瀏覽所選伺服器上的資料夾',
  'workspaces.dialog.name.label': '名稱',
  'workspaces.dialog.name.placeholder': '工作區名稱',
  'workspaces.dialog.color.label': '顏色',
  'workspaces.dialog.color.placeholder': '選填',
  'workspaces.dialog.actions.add': '新增工作區',
  'workspaces.dialog.actions.adding': '正在新增...',
  'workspaces.dialog.error.required': '請選擇伺服器並輸入路徑。',
  'workspaces.dialog.error.createFailed': '無法新增工作區。',
  'workspaces.dialog.toast.added': '已新增工作區「{label}」',
  'workspaces.dialog.browse.loading': '正在載入資料夾...',
  'workspaces.dialog.browse.loadFailed': '無法瀏覽資料夾。',
  'workspaces.dialog.browse.empty': '這裡沒有資料夾。',
  'workspaces.dialog.browse.choose': '選擇此資料夾',
  'workspaces.dialog.browse.upAria': '前往上一層資料夾',

...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.header.openProjectAria': '開啟專案面板',
  ...
  'sessions.sidebar.group.empty.noSessionsInProject': '該專案暫無會話。',
  ...
  'gitView.empty.worktreeFeaturesUnavailable': '目前專案模式下，worktree 功能無法使用。',
  ...
  'projects.dialog.title': '新增專案',
  'projects.sidebar.title': '專案',
  'projects.sidebar.empty': '尚無專案。',
  'projects.sidebar.empty.add': '新增專案',
  'projects.sidebar.stale': '已過期',
  'projects.sidebar.serverOf': '在 {server} 上',
  'projects.sidebar.moreAvailable': '還有更多會話',
  'projects.sidebar.menu.edit': '編輯...',
  'projects.sidebar.menu.remove': '移除',
  'projects.sidebar.menu.removeConfirm': '移除 {label}？',
  'projects.sidebar.serverHasMoreSessions': '此伺服器上還有更多會話',
  'projects.sidebar.openSessionAria': '在 {project} 中開啟 {title}',
  'projects.sidebar.unavailable': '此環境中專案不可用。',
  'projects.sidebar.newSessionUnavailable': '暫時無法在此伺服器上建立新工作階段。',
  'projects.sidebar.capabilityDisabled.title': '專案目錄已停用',
  'projects.sidebar.capabilityDisabled.description': '伺服器管理員已停用專案目錄。你的專案會被保留並以唯讀方式顯示——新增、編輯和開啟專案均不可用。',
  'projects.capability.terminalUnavailable': '此專案的連線不支援終端機。',
  'projects.dialog.description': '選擇伺服器及其上的路徑。所有伺服器的專案都顯示在同一個清單中。',
  'projects.dialog.server.label': '伺服器',
  'projects.dialog.server.placeholder': '選擇伺服器',
  'projects.dialog.server.loading': '正在載入伺服器...',
  ...
  'projects.dialog.server.error.sshCommandRequired': '請輸入 SSH 命令。',
  ...
  'projects.dialog.server.form.type': '連線類型',
  'projects.dialog.server.form.typeUrl': 'URL',
  'projects.dialog.server.form.typeSsh': 'SSH',
  'projects.dialog.server.form.nickname': '暱稱',
  'projects.dialog.server.form.nicknamePlaceholder': '例如：建置伺服器',
  'projects.dialog.server.form.sshCommand': 'SSH 命令',
  'projects.dialog.server.form.sshCommandPlaceholder': '例如：ssh user@host',
  'projects.dialog.server.form.sshCreated': '已建立 SSH 連線。可在伺服器設定中管理。',
  'projects.dialog.server.form.save': 'Save server',
  'projects.dialog.server.form.saving': 'Saving...',
  'projects.dialog.server.thisComputer': '此電腦',
  'projects.dialog.serverProbe.checking': '正在檢查連線...',
  'projects.dialog.serverProbe.connected': '伺服器已連線',
  'projects.dialog.serverProbe.connectedWithLatency': '伺服器在 {latencyMs} ms 內已連線',
  'projects.dialog.serverProbe.unreachable': '伺服器無法連線。它已被註冊——你可以重試或繼續。',
  'projects.dialog.serverProbe.retry': '重試',
  'projects.dialog.serverProbe.continue': '繼續',
  'projects.dialog.serverProbe.registeredNote': '伺服器已註冊，但無法連線',
  'projects.dialog.path.label': '路徑',
  'projects.dialog.path.placeholder': '選擇或輸入伺服器上的路徑',
  'projects.dialog.path.browse': '瀏覽',
  'projects.dialog.path.browseAria': '瀏覽所選伺服器上的資料夾',
  'projects.dialog.name.label': '名稱',
  'projects.dialog.name.placeholder': '專案名稱',
  'projects.dialog.color.label': '顏色',
  'projects.dialog.color.placeholder': '選填',
  'projects.dialog.actions.add': '新增專案',
  'projects.dialog.actions.adding': '正在新增...',
  'projects.dialog.error.required': '請選擇伺服器並輸入路徑。',
  'projects.dialog.error.createFailed': '無法新增專案。',
  'projects.dialog.toast.added': '已新增專案「{label}」',
  'projects.dialog.browse.loading': '正在載入資料夾...',
  'projects.dialog.browse.loadFailed': '無法瀏覽資料夾。',
  'projects.dialog.browse.empty': '這裡沒有資料夾。',
  'projects.dialog.browse.choose': '選擇此資料夾',
  'projects.dialog.browse.upAria': '前往上一層資料夾',
  ...
  'chat.pendingChanges.changedInProject': '此專案中有變更',

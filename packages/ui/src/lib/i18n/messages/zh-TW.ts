...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.modelControls.loadingModels': '正在載入模型...',
  'chat.modelControls.modelLoadFailed': '從 {server} 載入模型失敗',
  ...
  'server.sidebar.status.reconnecting': '正在重新連線到 {label}...',
  'server.sidebar.status.clickToReconnect': '伺服器已中斷連線。點擊重新連線。',
  'server.sidebar.search.searchingServers': '正在搜尋 {count} 個伺服器',
  'server.sidebar.localLabel': '本機',
  'server.sidebar.manageServers': '管理伺服器',
  'server.sidebar.actions.connect': '連線到伺服器',
  'server.sidebar.actions.disconnect': '中斷伺服器',
  'server.sidebar.actions.reconnect': '重新連線',
  'server.sidebar.actions.disconnectConfirm': '確定要中斷此伺服器嗎？',
  'server.sidebar.status.label': '伺服器狀態：{status}',
  'server.sidebar.type.remote': '遠端',
  'server.sidebar.noProjects': '{label} 上沒有專案。',
  'directoryExplorerDialog.server.placeholder': '選擇伺服器...',
  'directoryExplorerDialog.server.disconnected': '伺服器已中斷連線',
  'directoryExplorerDialog.remote.listing': '正在列出 {server} 上的檔案...',
  'directoryExplorerDialog.remote.timeout': '遠端伺服器回應逾時',
  'directoryExplorerDialog.remote.disconnected': '伺服器已中斷連線',
  'directoryExplorerDialog.remote.error': '無法連線到 {server}',
  'directoryExplorerDialog.remote.returnToLocal': '返回本機',
  'directoryExplorerDialog.remote.retry': '重試',

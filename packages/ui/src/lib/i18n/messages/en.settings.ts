export const settingsDict = {
  ...
  'settings.view.nav.group.projects': 'Projects',
  'settings.view.nav.group.opencode': 'OpenCode',
  'settings.view.nav.group.content': 'Library',
  'settings.page.projects.title': 'Projects',
  'settings.page.servers.title': 'Servers',
  'settings.page.devices.title': 'Devices',
  'settings.page.servers.description': 'Manage saved servers and their connection status.',
  'settings.page.remoteInstances.title': 'Remote instances',
  'settings.servers.sidebar.total': 'Total {count}',
  'settings.servers.sidebar.actions.addServer': 'Add server',
  'settings.servers.page.unavailable': 'Servers are unavailable right now.',
  'settings.servers.page.status.checking': 'Checking...',
  'settings.servers.page.status.connected': 'Connected',
  'settings.servers.page.status.unreachable': 'Unreachable',
  'settings.servers.page.status.neverConnected': 'Never connected',
  'settings.servers.page.status.latency': '{latencyMs} ms',
  'settings.servers.page.lastConnectedAt': 'Last connected: {date}',
  'settings.servers.page.freshness.label': 'Session index',
  'settings.servers.page.freshness.synced': 'Synced',
  'settings.servers.page.freshness.stale': 'Stale',
  'settings.servers.page.freshness.offline': 'Offline',
  'settings.servers.page.freshness.unknown': 'Unknown',
  'settings.servers.page.actions.addServer': 'Add server',
  'settings.servers.page.actions.addServerDescription': 'Register a new server by URL and access token.',
  'settings.servers.page.actions.test': 'Test connection',
  'settings.servers.page.actions.edit': 'Edit label',
  'settings.servers.page.actions.remove': 'Remove',
  'settings.servers.page.empty.noServers': 'No servers yet. Add one to use projects from other machines.',
  'settings.servers.page.section.addServer': 'Add server',
  'settings.servers.page.edit.title': 'Edit server',
  'settings.servers.page.edit.keepUrl': 'Leave empty to keep the current URL',
  'settings.servers.page.edit.keepToken': 'Leave empty to keep the current token',
  'settings.servers.page.edit.labelRequired': 'Enter a server name.',
  'settings.servers.page.edit.actions.save': 'Save',
  'settings.servers.page.confirm.remove.title': 'Remove server?',
  'settings.servers.page.confirm.remove.description': 'The server will be removed from your saved connections.',
  'settings.servers.page.confirm.remove.confirm': 'Remove',
  'settings.servers.page.toast.removed': 'Server removed',
  'settings.servers.probe.checking': 'Checking connection...',
  'settings.servers.probe.unreachable': 'Server unreachable. It was still registered — you can retry or continue.',
  'settings.servers.probe.retry': 'Retry',
  'settings.servers.probe.continue': 'Continue',

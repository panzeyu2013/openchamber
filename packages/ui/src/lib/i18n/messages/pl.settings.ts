export const settingsDict = {
  ...
  'settings.page.servers.title': 'Serwery',
  'settings.page.devices.title': 'Urządzenia',
  'settings.page.servers.description': 'Zarządzaj zapisanymi serwerami i ich stanem połączenia.',
  'settings.servers.sidebar.total': 'Razem: {count}',
  'settings.servers.sidebar.actions.addServer': 'Dodaj serwer',
  'settings.servers.page.unavailable': 'Serwery są w tej chwili niedostępne.',
  'settings.servers.page.status.checking': 'Sprawdzanie...',
  'settings.servers.page.status.connected': 'Połączono',
  'settings.servers.page.status.unreachable': 'Nieosiągalny',
  'settings.servers.page.status.neverConnected': 'Nigdy nie połączono',
  'settings.servers.page.status.latency': '{latencyMs} ms',
  'settings.servers.page.lastConnectedAt': 'Ostatnie połączenie: {date}',
  'settings.servers.page.freshness.label': 'Indeks sesji',
  'settings.servers.page.freshness.synced': 'Zsynchronizowano',
  'settings.servers.page.freshness.stale': 'Nieaktualny',
  'settings.servers.page.freshness.offline': 'Offline',
  'settings.servers.page.freshness.unknown': 'Nieznany',
  'settings.servers.page.actions.addServer': 'Dodaj serwer',
  'settings.servers.page.actions.addServerDescription': 'Zarejestruj nowy serwer po URL i tokenie dostępu.',
  'settings.servers.page.actions.test': 'Testuj połączenie',
  'settings.servers.page.actions.edit': 'Edytuj nazwę',
  'settings.servers.page.actions.remove': 'Usuń',
  'settings.servers.page.empty.noServers': 'Brak serwerów. Dodaj jeden, aby używać projektów z innych maszyn.',
  'settings.servers.page.section.addServer': 'Dodaj serwer',
  'settings.servers.page.edit.title': 'Edytuj serwer',
  'settings.servers.page.edit.keepUrl': 'Pozostaw puste, aby zachować bieżący URL',
  'settings.servers.page.edit.keepToken': 'Pozostaw puste, aby zachować bieżący token',
  'settings.servers.page.edit.labelRequired': 'Wprowadź nazwę serwera.',
  'settings.servers.page.edit.actions.save': 'Zapisz',
  'settings.servers.page.confirm.remove.title': 'Usunąć serwer?',
  'settings.servers.page.confirm.remove.description': 'Serwer zostanie usunięty z zapisanych połączeń.',
  'settings.servers.page.confirm.remove.confirm': 'Usuń',
  'settings.servers.page.toast.removed': 'Usunięto serwer',
  'settings.servers.probe.checking': 'Sprawdzanie połączenia...',
  'settings.servers.probe.unreachable': 'Serwer nieosiągalny. Został mimo to zarejestrowany — możesz spróbować ponownie lub kontynuować.',
  'settings.servers.probe.retry': 'Spróbuj ponownie',
  'settings.servers.probe.continue': 'Kontynuuj',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.view.nav.group.projects': 'Projekty',

...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.header.openProjectAria": "Abrir painel de projeto",
  ...
  "sessions.sidebar.group.empty.noSessionsInProject": "Ainda não há sessões neste projeto.",
  ...
  "gitView.empty.worktreeFeaturesUnavailable": "Os recursos de worktree não estão disponíveis neste modo de projeto.",
  ...
  "projects.dialog.title": "Adicionar projeto",
  "projects.sidebar.title": "Projetos",
  "projects.sidebar.empty": "Ainda não há projetos.",
  "projects.sidebar.empty.add": "Adicionar projeto",
  "projects.sidebar.stale": "Desatualizado",
  "projects.sidebar.serverOf": "em {server}",
  "projects.sidebar.moreAvailable": "Mais sessões disponíveis",
  "projects.sidebar.menu.edit": "Editar...",
  "projects.sidebar.menu.remove": "Remover",
  "projects.sidebar.menu.removeConfirm": "Remover {label}?",
  "projects.sidebar.serverHasMoreSessions": "Mais sessões disponíveis neste servidor",
  "projects.sidebar.openSessionAria": "Abrir {title} em {project}",
  "projects.sidebar.unavailable": "Os projetos não estão disponíveis neste ambiente.",
  "projects.sidebar.newSessionUnavailable": "Não é possível iniciar sessões neste servidor agora.",
  "projects.sidebar.capabilityDisabled.title": "O catálogo de projetos está desativado",
  "projects.sidebar.capabilityDisabled.description": "O administrador do servidor desativou o catálogo de projetos. Seus projetos são preservados e exibidos somente leitura — adicionar, editar e abrir projetos está indisponível.",
  "projects.capability.terminalUnavailable": "O terminal não está disponível para a conexão deste projeto.",
  "projects.dialog.description": "Escolha um servidor e um caminho nele. Os projetos de todos os servidores ficam em uma única lista.",
  "projects.dialog.server.label": "Servidor",
  "projects.dialog.server.placeholder": "Selecionar servidor",
  "projects.dialog.server.loading": "Carregando servidores...",
  ...
  "projects.dialog.server.error.sshCommandRequired": "Insira um comando SSH.",
  ...
  "projects.dialog.server.form.type": "Tipo de conexão",
  "projects.dialog.server.form.typeUrl": "URL",
  "projects.dialog.server.form.typeSsh": "SSH",
  "projects.dialog.server.form.nickname": "Apelido",
  "projects.dialog.server.form.nicknamePlaceholder": "ex.: Servidor de build",
  "projects.dialog.server.form.sshCommand": "Comando SSH",
  "projects.dialog.server.form.sshCommandPlaceholder": "ex.: ssh user@host",
  "projects.dialog.server.form.sshCreated": "Conexão SSH criada. Gerencie-a nas configurações de servidores.",
  "projects.dialog.server.form.save": "Save server",
  "projects.dialog.server.form.saving": "Saving...",
  "projects.dialog.server.thisComputer": "Este computador",
  "projects.dialog.serverProbe.checking": "Verificando conexão...",
  "projects.dialog.serverProbe.connected": "Servidor conectado",
  "projects.dialog.serverProbe.connectedWithLatency": "Servidor conectado em {latencyMs} ms",
  "projects.dialog.serverProbe.unreachable": "Servidor inacessível. Ele foi registrado mesmo assim — você pode tentar novamente ou continuar.",
  "projects.dialog.serverProbe.retry": "Tentar novamente",
  "projects.dialog.serverProbe.continue": "Continuar",
  "projects.dialog.serverProbe.registeredNote": "Servidor registrado, mas inacessível",
  "projects.dialog.path.label": "Caminho",
  "projects.dialog.path.placeholder": "Selecione ou digite um caminho no servidor",
  "projects.dialog.path.browse": "Procurar",
  "projects.dialog.path.browseAria": "Procurar pastas no servidor selecionado",
  "projects.dialog.name.label": "Nome",
  "projects.dialog.name.placeholder": "Nome do projeto",
  "projects.dialog.color.label": "Cor",
  "projects.dialog.color.placeholder": "Opcional",
  "projects.dialog.actions.add": "Adicionar projeto",
  "projects.dialog.actions.adding": "Adicionando...",
  "projects.dialog.error.required": "Escolha um servidor e digite um caminho.",
  "projects.dialog.error.createFailed": "Falha ao adicionar o projeto.",
  "projects.dialog.toast.added": "Projeto \"{label}\" adicionado",
  "projects.dialog.browse.loading": "Carregando pastas...",
  "projects.dialog.browse.loadFailed": "Falha ao procurar pastas.",
  "projects.dialog.browse.empty": "Nenhuma pasta aqui.",
  "projects.dialog.browse.choose": "Escolher esta pasta",
  "projects.dialog.browse.upAria": "Ir para a pasta pai",
  ...
  "chat.pendingChanges.changedInProject": "modificado neste projeto",

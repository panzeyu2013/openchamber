...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.modelControls.loadingModels": "Carregando modelos...",
  "chat.modelControls.modelLoadFailed": "Falha ao carregar modelos de {server}",
  ...
  "desktopHostSwitcher.actions.removeServerAria": "Remover servidor",
  "desktopHostSwitcher.actions.removeServer": "Remover servidor",
  ...
  "desktopHostSwitcher.toast.sshDisconnected": "Instância SSH \"{host}\" desconectada",
  "desktopHostSwitcher.toast.instanceUnreachable": "Instância \"{host}\" não está disponível",
  "server.sidebar.status.connectionError": "Erro de conexão",
  "server.sidebar.status.disconnected": "Desconectado",
  "server.sidebar.status.reconnecting": "Reconectando a {label}...",
  "server.sidebar.status.clickToReconnect": "Servidor desconectado. Clique para reconectar.",
  "server.sidebar.search.searchingServers": "Buscando em {count} servidores",
  "server.sidebar.localLabel": "Local",
  "server.sidebar.manageServers": "Gerenciar servidores",
  "server.sidebar.actions.connect": "Conectar ao servidor",
  "server.sidebar.actions.disconnect": "Desconectar servidor",
  "server.sidebar.actions.reconnect": "Reconectar",
  "server.sidebar.actions.disconnectConfirm": "Tem certeza de que deseja desconectar este servidor?",
  "server.sidebar.status.label": "Status do servidor: {status}",
  "server.sidebar.type.remote": "Remoto",
  "server.sidebar.noProjects": "Nenhum projeto em {label}.",
  "directoryExplorerDialog.server.placeholder": "Selecionar servidor...",
  "directoryExplorerDialog.server.disconnected": "Servidor desconectado",
  "directoryExplorerDialog.remote.listing": "Listando arquivos em {server}...",
  "directoryExplorerDialog.remote.timeout": "A resposta do servidor remoto expirou",
  "directoryExplorerDialog.remote.disconnected": "Servidor desconectado",
  "directoryExplorerDialog.remote.error": "Não foi possível conectar a {server}",
  "directoryExplorerDialog.remote.returnToLocal": "Voltar ao local",
  "directoryExplorerDialog.remote.retry": "Tentar novamente",

...
export const dict = {
  ...
  'sessions.sidebar.group.empty.noSessionsInProject': 'Aucune session dans ce projet pour le moment.',
  ...
  'gitView.empty.worktreeFeaturesUnavailable': 'Les fonctionnalités Worktree ne sont pas disponibles dans ce mode projet.',
  ...
  'projects.dialog.title': 'Ajouter un projet',
  'projects.sidebar.title': 'Projets',
  'projects.sidebar.empty': 'Aucun projet pour l’instant.',
  'projects.sidebar.empty.add': 'Ajouter un projet',
  'projects.sidebar.stale': 'Obsolète',
  'projects.sidebar.serverOf': 'sur {server}',
  'projects.sidebar.moreAvailable': 'D’autres sessions sont disponibles',
  'projects.sidebar.menu.edit': 'Modifier...',
  'projects.sidebar.menu.remove': 'Supprimer',
  'projects.sidebar.menu.removeConfirm': 'Supprimer {label} ?',
  'projects.sidebar.serverHasMoreSessions': 'D’autres sessions sont disponibles sur ce serveur',
  'projects.sidebar.openSessionAria': 'Ouvrir {title} dans {project}',
  'projects.sidebar.unavailable': 'Les projets ne sont pas disponibles dans cet environnement.',
  'projects.sidebar.newSessionUnavailable': 'Impossible de créer des sessions sur ce serveur pour le moment.',
  'projects.sidebar.capabilityDisabled.title': 'Le catalogue de projets est désactivé',
  'projects.sidebar.capabilityDisabled.description': 'L’administrateur du serveur a désactivé le catalogue de projets. Vos projets sont conservés et affichés en lecture seule — l’ajout, la modification et l’ouverture de projets sont indisponibles.',
  'projects.capability.terminalUnavailable': 'Le terminal n\'est pas disponible pour la connexion de ce projet.',
  'projects.dialog.description': 'Choisissez un serveur et un chemin sur ce serveur. Les projets de tous les serveurs figurent dans une seule liste.',
  'projects.dialog.server.label': 'Serveur',
  'projects.dialog.server.placeholder': 'Sélectionner un serveur',
  'projects.dialog.server.loading': 'Chargement des serveurs...',
  'projects.dialog.server.add': 'Add server...',
  'projects.dialog.server.error.required': 'Enter a label and a server URL.',
  'projects.dialog.server.error.createFailed': 'Failed to add server.',
  'projects.dialog.server.error.sshCommandRequired': 'Saisissez une commande SSH.',
  'projects.dialog.server.form.label': 'Server name',
  'projects.dialog.server.form.labelPlaceholder': 'e.g. Build server',
  'projects.dialog.server.form.url': 'Server URL',
  'projects.dialog.server.form.token': 'Access token (optional)',
  'projects.dialog.server.form.tokenPlaceholder': 'Paste an access token',
  'projects.dialog.server.form.type': 'Type de connexion',
  'projects.dialog.server.form.typeUrl': 'URL',
  'projects.dialog.server.form.typeSsh': 'SSH',
  'projects.dialog.server.form.nickname': 'Surnom',
  'projects.dialog.server.form.nicknamePlaceholder': 'p. ex. Serveur de build',
  'projects.dialog.server.form.sshCommand': 'Commande SSH',
  'projects.dialog.server.form.sshCommandPlaceholder': 'p. ex. ssh user@host',
  'projects.dialog.server.form.sshCreated': 'Connexion SSH créée. Vous pouvez la gérer dans les paramètres des serveurs.',
  'projects.dialog.server.form.save': 'Save server',
  'projects.dialog.server.form.saving': 'Saving...',
  'projects.dialog.server.thisComputer': 'Cet ordinateur',
  'projects.dialog.serverProbe.checking': 'Vérification de la connexion...',
  'projects.dialog.serverProbe.connected': 'Serveur connecté',
  'projects.dialog.serverProbe.connectedWithLatency': 'Serveur connecté en {latencyMs} ms',
  'projects.dialog.serverProbe.unreachable': 'Serveur injoignable. Il a tout de même été enregistré — vous pouvez réessayer ou continuer.',
  'projects.dialog.serverProbe.retry': 'Réessayer',
  'projects.dialog.serverProbe.continue': 'Continuer',
  'projects.dialog.serverProbe.registeredNote': 'Serveur enregistré, mais injoignable',
  'projects.dialog.path.label': 'Chemin',
  'projects.dialog.path.placeholder': 'Sélectionnez ou saisissez un chemin sur le serveur',
  'projects.dialog.path.browse': 'Parcourir',
  'projects.dialog.path.browseAria': 'Parcourir les dossiers du serveur sélectionné',
  'projects.dialog.name.label': 'Nom',
  'projects.dialog.name.placeholder': 'Nom du projet',
  'projects.dialog.color.label': 'Couleur',
  'projects.dialog.color.placeholder': 'Facultatif',
  'projects.dialog.actions.add': 'Ajouter le projet',
  'projects.dialog.actions.adding': 'Ajout en cours...',
  'projects.dialog.error.required': 'Choisissez un serveur et saisissez un chemin.',
  'projects.dialog.error.createFailed': 'Échec de l’ajout du projet.',
  'projects.dialog.toast.added': 'Projet « {label} » ajouté',
  'projects.dialog.browse.loading': 'Chargement des dossiers...',
  'projects.dialog.browse.loadFailed': 'Échec du parcours des dossiers.',
  'projects.dialog.browse.empty': 'Aucun dossier ici.',
  'projects.dialog.browse.choose': 'Choisir ce dossier',
  'projects.dialog.browse.upAria': 'Aller au dossier parent',
  ...
  'chat.pendingChanges.changedInProject': 'modifié dans ce projet',
  ...
  'mobile.header.openProjectAria': 'Ouvrir le panneau de projet',

...
export const dict = {
  ...
  'sessions.sidebar.header.actions.addWorkspace': 'Ajouter un espace de travail',
  ...
  'workspaces.dialog.title': 'Ajouter un espace de travail',
  'workspaces.sidebar.title': 'Espaces de travail',
  'workspaces.sidebar.empty': 'Aucun espace de travail pour l’instant.',
  'workspaces.sidebar.empty.add': 'Ajouter un espace de travail',
  ...
  'workspaces.dialog.server.placeholder': 'Sélectionner un serveur',
  'workspaces.dialog.server.loading': 'Chargement des serveurs...',
  ...
  'workspaces.dialog.server.thisComputer': 'Cet ordinateur',
  'workspaces.dialog.path.label': 'Chemin',
  'workspaces.dialog.path.placeholder': 'Sélectionnez ou saisissez un chemin sur le serveur',
  'workspaces.dialog.path.browse': 'Parcourir',
  'workspaces.dialog.path.browseAria': 'Parcourir les dossiers du serveur sélectionné',
  'workspaces.dialog.name.label': 'Nom',
  'workspaces.dialog.name.placeholder': 'Nom de l\u2019espace de travail',
  'workspaces.dialog.color.label': 'Couleur',
  'workspaces.dialog.color.placeholder': 'Facultatif',
  'workspaces.dialog.actions.add': 'Ajouter l\u2019espace de travail',
  'workspaces.dialog.actions.adding': 'Ajout en cours...',
  'workspaces.dialog.error.required': 'Choisissez un serveur et saisissez un chemin.',
  'workspaces.dialog.error.createFailed': 'Échec de l\u2019ajout de l\u2019espace de travail.',
  'workspaces.dialog.toast.added': 'Espace de travail «\u00a0{label}\u00a0» ajouté',
  'workspaces.dialog.browse.loading': 'Chargement des dossiers...',
  'workspaces.dialog.browse.loadFailed': 'Échec du parcours des dossiers.',
  'workspaces.dialog.browse.empty': 'Aucun dossier ici.',
  'workspaces.dialog.browse.choose': 'Choisir ce dossier',
  'workspaces.dialog.browse.upAria': 'Aller au dossier parent',

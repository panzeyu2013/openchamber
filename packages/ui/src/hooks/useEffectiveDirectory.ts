 ...
 * 4. Bound project directory, or the ambient DirectoryStore only when no
 *    project target is active
 *
...
export const useEffectiveDirectory = (): string | undefined => {
    ...
    // A project target with no resolved handle is unavailable, not a reason

 ...
 * - Leases: a Session Index or an active ProjectRuntimeHandle acquires a
 ...
 * project-prefixed HTTP/SSE/WS forwarding through `adapter.fetch`,
...
export const createConnectionBroker = (dependencies = {}) => {
  ...
  const log = (message, detail) => {
    logger?.log?.(`[projects:broker] ${message}`, detail ?? '');
  };
